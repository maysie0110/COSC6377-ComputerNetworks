...
class YouTube(object):
    ...
    def __init__(self, video, resolution, driver, config):
        self.url = video['url']
    ...
    # def load_video(self):
    #     print("Loading url {0}".format(self.url))
    ...
    def collect_stats(self):
        try:
            ...
            for i in range(n):
                ...
                print(i)
                new_data = deepcopy(stat_dict)
                self.data.append(new_data)
                print("Stat_dict {0}".format(stat_dict))
    ...
    def play(self):
        # metadata = self.get_content_metadata()
